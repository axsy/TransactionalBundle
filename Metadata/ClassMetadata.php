...
class ClassMetadata extends BaseClassMetadata
{
    ...
    public function createMethodMetadata($name)
    {
        ...
        $metadata->rollbackOnExceptions = $this->rollbacOnExceptions;
    ...
    {
        parent::addMethodMetadata($metadata); // TODO: Change the autogenerated stub
    }
    ...
    public function merge(MergeableInterface $metadata)
    {
        ...
        foreach($this->methodMetadata as $name => $methodMetadata) {
            ...
            if ($metadata->name != $methodMetadata->getDeclarigClass()->name) {
